...
function pano2vrPlayer(h) {
    ...
    function jd(a) {
        ...
        if (!ca && (0 <= Q && (a.preventDefault(), (a.which || 0 == a.which || 1 == a.which) && ad(a.pageX, a.pageY), K()), b.hotspot == b.emptyHotspot || "poly" == b.hotspot.type)) {
            ...
            b.hotspot != c && (b.hotspot != b.emptyHotspot && (0 < R && (b.hotspot.C = 0), b.skinObj && b.skinObj.hotspotProxyOut &&
                b.skinObj.hotspotProxyOut(b.hotspot.id)), c ? (b.hotspot = c, b.skinObj && b.skinObj.hotspotProxyOver && b.skinObj.hotspotProxyOver(b.hotspot.id), S.style.cursor = "pointer", 0 < R && (ya = 1, b.hotspot.C = 1)) : (b.hotspot = b.emptyHotspot, S.style.cursor = "inherit", 0 < R && (ya = 0)));
    ...
    b.readConfigUrl = function(a, d, c) {
        try {
            ...
            f.open("GET", a, r);
            f.send(o);
            console.log("PLESSS " + document.location.origin + document.location.pathname);
            if (f.responseXML) {
                var e = a.lastIndexOf("/");
